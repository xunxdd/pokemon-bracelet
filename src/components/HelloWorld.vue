          ...
          <v-flex xs12 sm4 class="my-3">
            <div class="text-xs-center">
              ...
              <span class="subheading">
                agjdgk dlgka; gdg algjalgj algjal gj
              </span>
            </div>
          </v-flex>
          <v-flex xs12>
        ...
        <v-container grid-list-xl>
          <v-layout row wrap justify-center class="my-5">
            ...
            <v-flex xs12 sm4 offset-sm1>
              <v-card class="elevation-0 transparent">
                <v-card-title primary-title class="layout justify-center">
                  <div class="headline">DO NOT Contact us</div>
                </v-card-title>
                <v-card-text>
                  Cras facilisis mi vitae nunc lobortis pharetra. Nulla volutpat tincidunt ornare.
                </v-card-text>
                <v-list class="transparent">
                  <v-list-tile>
                    ...
                    <v-list-tile-content>
                      <v-list-tile-title>111-111-1111</v-list-tile-title>
                    </v-list-tile-content>
                  </v-list-tile>
                  <v-list-tile>
                    <v-list-tile-action>
                    ...
                    <v-list-tile-content>
                      <v-list-tile-title>Outside, not in</v-list-tile-title>
                    </v-list-tile-content>
                  </v-list-tile>
                  <v-list-tile>
                    <v-list-tile-action>
                    ...
                    <v-list-tile-content>
                      <v-list-tile-title>gopoke@bracelet.com</v-list-tile-title>
                    </v-list-tile-content>
                  </v-list-tile>
                </v-list>
              </v-card>
